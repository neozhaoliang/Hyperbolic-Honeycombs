...
In this project, we examine [Coxeter groups](https://en.wikipedia.org/wiki/Coxeter_group) generated by mirror reflections in spherical, Euclidean, and hyperbolic spaces. The number of mirrors used to generate the group is referred to as its rank (not precise, but you get the idea).

...
The level of a Coxeter group $G$ is the least non-negative integer $l$, such that if deleting any $l$ vertices in the Coxeter diagram of $G$, the remaining diagram is finite or affine.

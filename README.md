...
In this project, we consider [Coxeter groups](https://en.wikipedia.org/wiki/Coxeter_group) generated by mirror reflections in spherical, Euclidean and hyperbolic spaces. The number of independent mirrors is called the rank of the group (not precise, but you get the idea).

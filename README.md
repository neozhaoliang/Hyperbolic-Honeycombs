...
In this project, we consider [Coxeter groups](https://en.wikipedia.org/wiki/Coxeter_group) generated by mirror reflections in spherical, Euclidean and hyperbolic spaces. The number of mirrors is called the rank of the group (not precise, but you get the idea).
...
(Images with small Poincaré disks packing the boundary are of level 2)
